...
3. 해당 컨셉에 가장 맞는 레퍼런스 후보와 프롬프트 섹션(도시배경/여름/카페/하늘/공부/하이틴/Groove Hiphop)을 결정한다
...
추천 레퍼런스: {레퍼런스 경로/파일명}
적용 프롬프트 섹션: {도시배경/여름/카페/하늘/공부/하이틴/Groove Hiphop 중 하나}
...
| 음악 장르 | 1순위 폴더 | 2순위 폴더 | scene-prompts 섹션 |
|-----------|-----------|-----------|-------------------|
| Lo-fi Focus & Cafe Chill | 카페 | 공부 | 카페 / 공부 |
| Groove Hip-hop & Chill Pop | Groove hiphop | 도시배경 | Groove Hiphop / 도시배경 |
| Late Night R&B & Soul | 감성R&B | 도시야경 | 하이틴 / 도시야경 |
| Upbeat City Pop & Funk Groove | 도시배경 | 여름 | 도시배경 / 여름 |
| Acoustic Indie Pop & Folk Soul | 어쿠스틱팝 | 하늘 | 어쿠스틱팝 / 하늘 |
| Chillwave & Synth Pop | 도시야경 | 드라이브 | 도시야경 / 드라이브 |
| Jazz-hop & Bossa Nova Chill | 카페 | 감성R&B | 카페 / 하이틴 |

> **감성R&B 폴더 → scene 섹션은 "하이틴"을 사용한다.** (하이틴 섹션이 emotional R&B 무드를 다룸)
...
| `srefBase64` | base64 배열 | 레퍼런스 이미지 **1장** (파일명 기반 선정) |
